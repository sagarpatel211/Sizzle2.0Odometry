...
void pre_auton( void ) {
  ...
  //SET VALUES FOR INITIAL ROBOT POSITION (change values for robot starting pos.)
  X = 0; //x coordinate of inital robot position
  Y = 0; //y coordinate of inital robot position
}
/*---------------------------------------------------------------------------*/
/*                              Autonomous Task                              */
/*---------------------------------------------------------------------------*/
...
int main() {
    pre_auton();  //Runs the pre-autonomous function
